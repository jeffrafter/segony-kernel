 ...
 */
class ValidSiteAndLayoutSpyTest extends SpyTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->spyInstance = $this->getSpy('site', 'test');
    ...
    {
        $this->assertSame('site/test', $this->spyInstance->getClientController());
    }
